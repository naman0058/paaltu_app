					...
					<div class="card-body">
						<form action="{{route('interest.store')}}" method="post">
							...
							<div class="form-group col-md-6 mb-3">
								...
								<input type="datetime-local" class="form-control" name="date_and_time" id="date_and_time" placeholder="Date & Time"required>
							</div>
							<div class="form-group col-md-6 mb-3">
							...
							<div class="form-group col-md-6 mb-3">
								...
								<select class="array-select form-control form-select" name="from_pet_id" placeholder="Pet">
                           ...
                           @endforeach()
							...
							<div class="form-group col-md-6 mb-3">
								<label> To Pet </label>
								<select class="array-select form-control form-select" name="to_pet_id" placeholder="Pet">
									<option value="">Select Pet</option>
									@foreach($pets as $pet)
                           <option value="{{$pet->id}}">{{$pet->pet_name}}</option>
                           @endforeach()
