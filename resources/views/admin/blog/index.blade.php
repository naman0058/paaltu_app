...
<div class="page-toolbar px-xl-4 px-sm-2 px-0 py-3">
	<div class="row g-3 mb-3 align-items-center">
		...
		<div class="col text-md-end">
			<a class="btn btn-primary" href="{{ route('blog.create')}}"><i class="fa fa-plus me-2"></i>Add New Blog</a>	
		</div>
	</div>
...
<div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-0 mt-lg-1">
	<div class="row g-2 clearfix">
		<div class="col-md-12 mt-4">
			<div class="card">
				<div class="card-body">
					<table id="blog-table" class="table display dataTable table-hover" style="width:100%">
						<thead>
							<tr>
								<th>S.No</th>
								<th>Image</th>
...
var tableX = $('#blog-table').DataTable({
processing:true,
serverSide:true,
ajax: {
  url: "{{url('filter-blog') }}",
...
$(document).on('click','.blogViewBtn',function(){
$('#blogShow').html('');
$.ajax({
    url:"{{url('blog-view')}}",
	type:"get",
