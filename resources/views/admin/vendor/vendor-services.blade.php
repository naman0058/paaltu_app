	...
	<div class="row g-3 mb-3 align-items-center">
		<div class="col">
			<ol class="breadcrumb bg-transparent mb-0">
				...
				<li class="breadcrumb-item active" aria-current="page">Vendors Services</li>
			</ol>
		</div>
...
<script type="text/javascript">
	var tableX = $('#service-table').DataTable({
		...
		serverSide:true,
		ajax: {
			url: "{{url('vendors-service-filter/'.request()->id) }}",
			data: function (d) {
				d.name = $("#name").val()
			}
		},
		"columns" : [
			...
			{ data : "slot_hour", name : "slot_hour" },
			{ data : "slot_minutes", name : "slot_minutes" },
