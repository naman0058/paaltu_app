			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card">
					<div class="card-header"style="background-color:#ad006066;">
						<h6 class="card-title mb-0"style="color:white"></h6>
						...
						<form action="{{route('vendors.update',$data->id)}}" method="post"  enctype="multipart/form-data">
							...
							@method('PUT')
						   	<div class="row">
								...
								<div class="form-group col-md-6 mb-3">
									<label> Email </label>
									<input type="text" class="form-control" name="email" id="email" placeholder="Email" value="{{$data->email}}" required>
									@if($errors->has('email'))
								...
								<div class="form-group col-md-6 mb-3">
									...
									<input type="text" class="form-control" name="alt_mobile" id="alt_mobile" placeholder="Alternative Mobile" value="{{$data->alt_mobile}}">
								</div>
								<div class="form-group col-md-6 mb-3">
									<label>Icon</label>
									<input type="file" class="form-control dropify" name="icon" id="icon_id" placeholder="Icon"  data-default-file="{{asset('public/uploads/vendor/'.$data->icon)}}">
								</div>
								<div class="form-group col-md-6 mb-3">
									<label>Address</label>
									<textarea class="form-control" name="address"rows="8" required>{{$data->address}}</textarea>
