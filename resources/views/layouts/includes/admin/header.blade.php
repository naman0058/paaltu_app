        ...
        <nav class="navbar">
          ...
          <div class="d-flex">
            ...
            <a href="{{route('dashboard')}}" class="brand-icon d-flex align-items-center mx-2 mx-sm-3 text-primary"> 
             ...
             <h4 class="sidebar-title mb-0 flex-grow-1 "><span style="color:violet">paal</span><span style="color:black">tu</span></h4>
                        ...
                        <ul class="list-unstyled list mb-0">
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="{{ asset('assets/admin/img/xs/avatar5.jpg') }}" alt="">
                          ...
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="{{ asset('assets/admin/img/xs/avatar6.jpg') }}" alt="">
                              <div class="flex-fill ms-3">
                          ...
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="{{ asset('assets/admin/img/xs/avatar1.jpg') }}" alt="">
                              <div class="flex-fill ms-3">
                          ...
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="{{ asset('assets/admin/img/xs/avatar3.jpg') }}" alt="">
                              <div class="flex-fill ms-3">
                          ...
                          <li class="py-2 mb-1 border-bottom">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="{{ asset('assets/admin/img/xs/avatar4.jpg') }}" alt="">
                              <div class="flex-fill ms-3">
                          ...
                          <li class="py-2">
                            <a href="javascript:void(0);" class="d-flex">
                              <img class="avatar rounded-circle" src="{{ asset('assets/admin/img/xs/avatar7.jpg') }}" alt="">
                              <div class="flex-fill ms-3">
                ...
                <div class="dropdown-menu rounded-4 shadow border-0 p-0" data-bs-popper="none">
                  <div class="card">
                    <div class="row g-1 text-center p-3" style="width: 302px;">
                      <div class="col-6">
                        <a class="card p-3 color-600 lift align-items-center" href="#" title="">
              ...
              <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                ...
                <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                  ...
                  <!--   <div class="list-group m-2 mb-3">
                      ...
                      <a class="list-group-item list-group-item-action border-0" href="#"><i class="w30 fa fa-credit-card"></i>Billing</a>
                      <a class="list-group-item list-group-item-action border-0" href="#"><i class="w30 fa fa-users"></i>Manage Team</a>
                      <a class="list-group-item list-group-item-action border-0" href="#"><i class="w30 fa fa-calendar"></i>My Events</a>
                      <a class="list-group-item list-group-item-action border-0" href="#"><i class="w30 fa fa-tag"></i>Support Ticket</a>
                    </div>  -->
